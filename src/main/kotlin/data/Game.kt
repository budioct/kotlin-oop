...
// keyword data generate method component untuk Destructuring Declaration variable
data class Game(val name: String, val price: Int) {

    /**
     * Destructuring Declaration
     * ● Destructuring declaration adalah membuat multiple variables dari sebuah object yang sudah ada
    ...
    // destructuring declaration manual
