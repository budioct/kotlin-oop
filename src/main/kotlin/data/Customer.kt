...
open class Customer(val name: String, val type: String, val balance: Long) {
    constructor(name: String, type: String) : this(name, type, 0) // secondary constructor 1
    constructor(name: String) : this(name, "Standart") // // secondary constructor 2
}

class PremiumCustomer : Customer {
    constructor(name: String) : super(name, "Premium") // secondary constructor 1 access super from parent class
